...
d3.parliament = function() {
    ...
    function parliament(data) {
        ...
        data.each(function(d) {
            ...
            // pokud uživatel neposkytl rozměry, vyplní svg:
            ...
            /***
             * vypočítat počet křesel a řad parlamentu */
            var nSeats = 0;
            ...
            (function() {
                ...
                while (maxSeatNumber < nSeats) {
                    nRows++;
                    b += a;
                    /* POZNÁMKA: počet dostupných křesel v každé řadě závisí na celkovém počtu
                    řad a floor() je potřeba, protože řada může obsahovat pouze celá křesla. Takže
                    není možné zvýšit celkový počet křesel přidáním řady. */
            ...
            /***
             * vytvoření seznamu křesel */
            /* vypočítat kartézské a polární souřadnice pro každé křeslo */
            ...
            /* seřadit křesla podle úhlu */
            seats.sort(function(a,b) {
                return a.polar.teta - b.polar.teta || b.polar.r - a.polar.r;
            });

            /* vyplnit objekty křesel daty jejich strany a sebou samými, pokud existují */
            (function() {
                var partyIndex = 0;
                var seatIndex = 0;
                seats.forEach(function(s) {
                    /* získat aktuální stranu a přejít na další, pokud má všechna svá křesla obsazená */
            ...
            /***
             * pomocné funkce pro získání hodnoty z dat křesla */
            ...
            /***
             * vyplnit svg křesly jako kruhy */
            /* kontejner parlamentu */
            ...
            /* kruhy zachycují události myši a dotyku */
            ...
            /* animace aktualizace křesel v parlamentu */
            if (update.animate) {
            ...
            /* animace odebírání křesel z parlamentu */
